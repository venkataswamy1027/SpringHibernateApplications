...
public class JsonControllerDaoImpl implements TeamDao {
	public ArrayList<TeamDto> teamList() {
			...
			try {
				...
				FileReader fileread = new FileReader(
						"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/DDTeamInfo.json");
	...
	public ArrayList<TeamDto> gujratTeam() {
		...
		try {
			//read jsonfile data  from local repository
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/GujratTeam.json");
	...
	public ArrayList punjabTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/PunjabTeam.json");
	...
	public ArrayList kkrTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/KKRTeam.json");
	...
	public ArrayList mumbaiIndiansTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/MumbaiIndians.json");
	...
	public ArrayList risingPuneTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/RisingPune.json");
	...
	public ArrayList royalChallengesTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/RoyalChallenges.json");
	...
	public ArrayList sunriseHydrabadTeam() {
		...
		try {
			...
			FileReader fileread = new FileReader(
					"/home/bridgeit/Documents/UserList/src/main/jsonfile/IPLTeam/SunriseHydrabad.json");
